...
import 'package:unit_converter/formulas/common/area_formula.dart';
    ...
    return Container(
      ...
      child: Center(
        child: DropdownButton<String>(
          ...
          items: areaItems.map((String dropDownStringItem) {
              ...
              children: [
                Obx(
                  () => Container(
                    width: Get.width * 0.5,
                    child: Text(
                      "${areaFormulas[_dropDownValue][index] * homeController.inputText}",
                      style: TextStyle(
                        fontSize: 18,
