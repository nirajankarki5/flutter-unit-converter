...
import 'package:unit_converter/formulas/common/length_formula.dart';
    ...
    return Container(
      ...
      child: Center(
        child: DropdownButton<String>(
          ...
          items: lengthItems.map((String dropDownStringItem) {
              ...
              children: [
                Obx(
                  () => Container(
                    width: Get.width * 0.5,
                    child: Text(
                      "${lengthFormulas[_dropDownValue][index] * homeController.inputText}",
                      style: TextStyle(
                        fontSize: 18,
